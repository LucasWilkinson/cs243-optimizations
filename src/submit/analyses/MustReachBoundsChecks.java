...
public class MustReachBoundsChecks implements Flow.Analysis {
    ...
    public static class CheckerSet implements Flow.DataflowObject {
        ...
        public String toString() {
            ...
            for (Map.Entry<String, CheckedArraySet> e : map.entrySet()) {
                ...
                string.append(e.getValue().toString());
            }
    ...
    public void preprocess (ControlFlowGraph cfg) {
        ...
        while (qit.hasNext()) 
        {
            ...
            {
                CheckerSet.register(def.toString());
            }

            if(q.getOperator() instanceof Operator.NewArray)
            {
                Operand array = Operator.NewArray.getDest(q);
                s.add(array.toString());
            } else if(q.getOperator() instanceof Operator.BoundsCheck) {
    ...
    public static class TransferFunction extends QuadVisitor.EmptyVisitor
    {
        ...
        public void visitQuad(Quad q) 
        {
        		if(q.getOperator() instanceof Operator.BoundsCheck)
        		{
                    ...
                    val.addArray(index.toString(), array.toString());
        		}
        		else if(q.getOperator() instanceof Operator.NewArray)
        		{
        			Operand reg = Operator.NewArray.getDest(q);
        			
        			val.removeArrayFromMap(reg.toString());
        		}
        		else
        		{
