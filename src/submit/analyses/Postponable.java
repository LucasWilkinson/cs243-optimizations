 ...
 */
public class Postponable implements Flow.Analysis {
    ...
    public class PostponableSet implements Flow.DataflowObject {
        ...
        {
            PostponableSet t = (PostponableSet)o;
        ...
        {
            if (o instanceof PostponableSet) 
            {
                PostponableSet a = (PostponableSet) o;
     ...
     */
    private PostponableSet[] in, out;
    private PostponableSet entry, exit;
    private static HashMap<String, TreeSet<String>> killSets;
    private static Set<String>[] earliest;
    ...
    public void registerEarliest(Set<String>[] earliest){
    ...
    public void preprocess(ControlFlowGraph cfg) {
        ...
        in = new PostponableSet[max];
        out = new PostponableSet[max];

        // initialize the contents of in and out.
        qit = new QuadIterator(cfg);
        while (qit.hasNext()) {
            int id = qit.next().getID();
            in[id] = new PostponableSet();
            out[id] = new PostponableSet();
        }
        ...
        transferfn.val = new PostponableSet();
        entry = new PostponableSet();
        exit = new PostponableSet();
    ...
    */
    ...
    public Flow.DataflowObject newTempVar() { return new PostponableSet(); }
    ...
    public static class TransferFunction extends QuadVisitor.EmptyVisitor {
        ...
        public void visitQuad(Quad q) {
            ...
            val.genExpressions(earliest[q.getID()]);

            if (isValidExpression(q)){
                val.killExpression(expressionString(q));
            }
        }
    }
}
